...
class Decoder(nn.Module):
    ...
    def forward(self, tgt_seq, tgt_pos, tgt_type, src_seq, src_score, enc_output, ext_fea=None, return_attns=False,
        ...
        dec_output = self.embeddings(tgt_seq, tgt_type, tgt_pos)  # (bs, len_tgt, d_model)
